...
where:
- \(F_i\) is the \(i\)-th label of the defined chemical processes.
- \(\hat{F}_i\) is the predicted chemical process feature matrix for the \(i\)-th cycle.
- \(\lambda_1\) is the regularization parameter, set to \(10^{-5}\).
